...
(
    ...
    rubber_to   smallint,
    diameter_AT_from decimal,
    diameter_AT_to decimal,
    length_L_AT_from decimal,
    length_L_AT_to decimal,
    diameter_IT_from decimal,
    diameter_IT_to decimal,
    length_L_IT_from decimal,
    length_L_IT_to decimal,
    diameter_ZT_from decimal,
    diameter_ZT_to decimal,
    length_L_ZT_from decimal,
    length_L_ZT_to decimal,
